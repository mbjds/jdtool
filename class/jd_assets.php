...
class jd_assets
{
    ...
    public function enqueue_admin_custom_css_js(): void
    {
        ...
        wp_enqueue_script('sweetalert2', 'https://cdn.jsdelivr.net/npm/sweetalert2@11.10.7/dist/sweetalert2.all.min.js', [], '11.10.7', true);
        wp_enqueue_style('animate-css', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css', [], '4.1.1');

        wp_enqueue_style('sweetalert2-css', 'https://cdn.jsdelivr.net/npm/sweetalert2@11.10.7/dist/sweetalert2.min.css', [], '11.10.7');
    }
