...
class jd_assets
{
    ...
    {
        add_action('wp_enqueue_scripts', [ $this, 'custom_enqueue_checkout_script' ], 999);
    ...
    public function custom_enqueue_checkout_script(): void
    {
        ...
        wp_enqueue_script('js-general-js', plugin_dir_url(__DIR__) . 'assets/js/global.js', null, '2.9');
        wp_enqueue_style('jd-style', plugin_dir_url(__DIR__) . 'assets/css/jd-checkout.css', false, '1.3', 'all');
        wp_enqueue_style('jd-general', plugin_dir_url(__DIR__) . 'assets/scss/general.css', false, '3.2', 'all');
        wp_enqueue_style('fa', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css');
