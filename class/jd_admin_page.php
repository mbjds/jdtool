...
public function __construct() {
	if ( is_admin() ){ // admin actions
		add_action( 'admin_menu', array($this, 'jdAdmin') );

		add_action( 'admin_init', array($this,'register_jdtools') );
	}
}
public function  register_jdtools() { // whitelist options
	...
	public function jdAdmin() {
		add_menu_page( 'JD Tools', 'JD Tools', 'manage_options', 'jd-tools', array($this, 'jdTools'), 'dashicons-tickets', 6  );
	}
...
?>
		<div class="wrap">
			...
			<form method="post" action="options.php">
				<?php
				settings_fields( 'jd-tools' ); // settings group name
				do_settings_sections( 'jd-tools' ); // just a page slug
