...
class jd_cli {
	...
	public function add_wp_cli_command() {
		if ( class_exists( 'WP_CLI' ) ) {
			WP_CLI::add_command( 'jds markVIP', array( $this, 'markVIP' ) );
			WP_CLI::add_command( 'jds markNonVIP', array( $this, 'markNonVIP' ) );
			WP_CLI::add_command( 'jds close', array( $this, 'closeOutdatedd' ) );
